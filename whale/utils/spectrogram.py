...
def cal_spectrogram(data, samp_rate, per_lap=0.9, wlen=None, mult=8.0):
    """
    ...
    if wlen is None:
        msg = "Please give a valid window length"
    ...
    nlap = int(wlen * samp_rate * float(per_lap))  # This line is
...
def show_spectrogram(
    ...
    kwargs = {
        k: v for k, v in (("cmap", cmap), ("zorder", zorder)) if v is not None
    }
